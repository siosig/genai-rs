...
PARITY_MATRIX = REPO_ROOT / "specs" / "001-port-genai-rust" / "contracts" / "parity-matrix.md"
...
def render(
    ...
    out.append(
        ...
        "**Source of truth**: `specs/001-port-genai-rust/contracts/parity-matrix.md`\n"
    )
    ...
    out.append(
        ...
        "`specs/001-port-genai-rust/contracts/parity-matrix.md` (the agreed source of truth). "
